...
function setupNavigationButtons(profile) {
    ...
    addApptsButton.addEventListener("click", () => navigateTo(`addNewAppt.html?id=${profile.id}&pic=${profile.pic}`));
    medicationFooterButton.addEventListener("click", () => navigateTo(`home.html?id=${profile.id}&pic=${profile.pic}`));
    appointmentFooterButton.addEventListener("click", () => navigateTo(`upcomingappt.html?id=${profile.id}&pic=${profile.pic}`));
    profileFooterButton.addEventListener("click", () => navigateTo(`profile.html?id=${profile.id}&pic=${profile.pic}`));
}
